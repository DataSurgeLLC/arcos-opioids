...
setting up EMR cluster with ML model steps:
`aws emr create-cluster --applications Name=Hadoop Name=Spark Name=Zeppelin --ec2-attributes '{"KeyName":"datasurge","InstanceProfile":"EMR_EC2_DefaultRole","SubnetId":"subnet-ca89a7ad","EmrManagedSlaveSecurityGroup":"sg-035d841a9b3bb6bfd","EmrManagedMasterSecurityGroup":"sg-0c2a79da0208f5455"}' --release-label emr-5.26.0 --log-uri 's3n://arcos-opioid/opioids/emr_logs/' --steps '[{"Args":["spark-submit","--deploy-mode","cluster","--class","io.jekal.arcos.ArcosModelMain","s3://arcos-opioid/opioids/jars/arcos_2.11.12-0.1-uber.jar","train"],"Type":"CUSTOM_JAR","ActionOnFailure":"TERMINATE_CLUSTER","Jar":"command-runner.jar","Properties":"","Name":"Spark application"},{"Args":["spark-submit","--deploy-mode","cluster","--class","io.jekal.arcos.ArcosModelMain","s3://arcos-opioid/opioids/jars/arcos_2.11.12-0.1-uber.jar","stats"],"Type":"CUSTOM_JAR","ActionOnFailure":"TERMINATE_CLUSTER","Jar":"command-runner.jar","Properties":"","Name":"Spark application"},{"Args":["spark-submit","--deploy-mode","cluster","--class","io.jekal.arcos.ArcosModelMain","s3://arcos-opioid/opioids/jars/arcos_2.11.12-0.1-uber.jar","report"],"Type":"CUSTOM_JAR","ActionOnFailure":"TERMINATE_CLUSTER","Jar":"command-runner.jar","Properties":"","Name":"Spark application"}]' --instance-groups '[{"InstanceCount":1,"BidPrice":"OnDemandPrice","InstanceGroupType":"MASTER","InstanceType":"r5d.xlarge","Name":"Master - 1"},{"InstanceCount":5,"BidPrice":"OnDemandPrice","InstanceGroupType":"CORE","InstanceType":"r5d.xlarge","Name":"Core - 2"}]' --configurations '[{"Classification":"spark","Properties":{"maximizeResourceAllocation":"true"}},{"Classification":"spark-log4j","Properties":{"log4j.rootCategory":"WARN, console"}}]' --auto-terminate --auto-scaling-role EMR_AutoScaling_DefaultRole --ebs-root-volume-size 10 --service-role EMR_DefaultRole --enable-debugging --name 'arcos' --scale-down-behavior TERMINATE_AT_TASK_COMPLETION --region us-east-1`
